...
| Останній реліз | **v1.12.0** (у `main` є незарелізена робота — див. `ROADMAP.md`) |
...
- Полиця: пошук, мітки, серії, пін, список/сітка, лічильник книг, групи за
  автором і циклом, кнопка «вгору» — розрахована на сотні книг
- Зниклі файли видно точно: бейдж каже «3 з 20» чи «20 з 20», а не просто «щось не так»
